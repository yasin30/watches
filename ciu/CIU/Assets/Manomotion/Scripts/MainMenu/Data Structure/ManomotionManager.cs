...
public class ManomotionManager : ManomotionBase
{
	...
	protected override void InstantiateSession()
	{
		...
		manomotion_session.orientation = Input.deviceOrientation;
		//This value will be in use through out different ManoMotionManagers capable of handling other addons.
	...
	protected void GetCameraFramePixelColors(ManoMotionFrame newFrame)
	{
		...
		Debug.LogFormat("Framepixel length {0} newFrame length {1}", framePixelColors.Length, newFrame.pixels.Length);
	...
	protected override void ProcessManomotion()
	{
		...
		{
			//I do get some frames here that they dont match because of 16x16
